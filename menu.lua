xdgmenu = function(terminal)
  return {
    {'Internet', --[[/usr/share/desktop-directories/Arch-Internet.directory]] {
        ...
        {'Firefox', 'firefox', '/usr/share/icons/HighContrast/32x32/apps/firefox.png' --[[/usr/share/applications/firefox.desktop]]},
        ...
        {'Xfce 终端', 'xfce4-terminal', '/usr/share/icons/HighContrast/32x32/apps/utilities-terminal.png' --[[/usr/share/applications/xfce4-terminal.desktop]]},
        ...
        {'Vi IMproved', 'gvim -f', '/usr/share/icons/HighContrast/32x32/apps/vim.png' --[[/usr/share/applications/gvim.desktop]]},
        {'Xgnokii', 'xgnokii', '/usr/share/icons/gnome/16x16/devices/phone.png' --[[/usr/share/applications/xgnokii.desktop]]},
        {'bpython', (terminal or "xterm") .. " -e '/usr/bin/bpython'", '/usr/share/pixmaps/bpython.png' --[[/usr/share/applications/bpython.desktop]]},
        {'ipython', (terminal or "xterm") .. " -e 'ipython'", '/usr/share/icons/gnome/16x16/status/gnome-netstatus-idle.png' --[[/usr/share/applications/ipython.desktop]]},
        ...
        {'在已有的 GVIM 里打开', 'vv', '/usr/share/icons/HighContrast/32x32/apps/vim.png' --[[/home/lilydjwg/.local/share/applications/vv.desktop]]},
